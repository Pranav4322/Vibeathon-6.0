import { TableAssignmentForm } from "./table-assignment-form";
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 p-4 sm:p-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-br from-emerald-500/10 to-transparent blur-3xl opacity-50" />
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-teal-600/10 to-transparent blur-3xl opacity-50" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Let us know how many people are dining today
          </p>
        </div>
